...
- Designed to be type-safe and easy to integrate into Kotlin projects.  
- Allows tracking changes to settings and performing side effects.  
- Readable, maintainable structure that blends naturally with Kotlin code.
...
For documentation, check out the [Kratos Documentation](https://schizoiddevelopment.github.io/kratos/).

[![Documentation](https://cdn.jsdelivr.net/npm/@intergrav/devins-badges@3/assets/cozy/documentation/ghpages_vector.svg)](https://schizoiddevelopment.github.io/kratos/)
